    ...
    <div class='col-md-6'>
      <div class='search-box'>
       <form action=""  method="get" class='search-form' >
          <input class='form-control' placeholder='ex: Tiffin services,food etc.' type="text" name="query">
...
$result = mysqli_query($con, "SELECT * FROM mess
		...
		<footer>	
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © 2023 Requisite. All Rights Reserved | Design by  <a href="#"> Rahul shukla</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
