...
{?> 
                ...
                <!--<a href="singleE.php">-->
                  ...
                  <form action='your_ad_deleteE.php? name="<?php echo $row['Ad_id']; ?>"' method="post">
		...
		<footer>	
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © 2023 Requisite. All Rights Reserved | Design by  <a href="http://w3layouts.com/"> Rahul shukla</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
