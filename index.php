...
$resultm=mysqli_query($con, "SELECT * FROM Mess ORDER BY Ad_id DESC LIMIT 4;");
$resulte=mysqli_query($con, "SELECT * FROM Furniture ORDER BY Ad_id DESC LIMIT 4;");
...
<script src="//code.tidio.co/qh3tayj35wvlxqsehotq6tws3mqrbfiv.js" async></script>
<body>
<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.php"><span>Requi</span>site</a>
		</div>
			<div class="dropdown">
...
?></button>
	...
	<div class="main-banner banner text-center">
	  <div class="container">    
			<h1>Your<span class="segment-heading" > One-Stop Solution for </span>Affordable and Convenient Living!</h1>
		...
		<!--	<div class="footer-top">
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © REQUISITE. All Rights Reserved</p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
