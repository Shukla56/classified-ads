...
{?> 
                ...
                <!--<a href="single.html">-->
                  ...
                  <form action='your_ad_deletef.php? name="<?php echo $row['Ad_id']; ?>"' method="post">
		...
		<footer>	
			...
			<div class="container">
				<div class="footer-logo">
					<a href="index.php"><span>Requisite</span></a>
				</div>
				...
				<div class="copyrights">
					<p> © 2023 Requiste. All Rights Reserved | Design by  <a href="#">Rahul shukla</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
