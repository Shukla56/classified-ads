...
INSERT INTO `Furniture` (`Ad_id`, `Ad_user_id`, `Ad_title`, `Ad_desc`, `Ad_price`, `Ad_image_path`, `user_name`, `user_phone`, `user_email`, `user_city`, `Ad_date`) VALUES
...
INSERT INTO `Mess` (`Ad_id`, `Ad_user_id`, `Ad_title`, `Ad_desc`, `Ad_price`, `Ad_image_path`, `user_name`, `user_phone`, `user_email`, `user_city`, `Ad_date`) VALUES
