...
$ad_id=$_GET['id'];
#echo $ad_id;
$result1=mysqli_query($con, "SELECT * FROM Mess WHERE Ad_id='$ad_id' LIMIT 1");
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active"><a href="mobiles.php">Mess</a></li>
		...
		<footer>
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © 2023 Requisite. All Rights Reserve by rahul shukla</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
