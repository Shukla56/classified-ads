...
$ad_id=$_GET['id'];
#echo $ad_id;
$result1=mysqli_query($con, "SELECT * FROM Furniture WHERE Ad_id='$ad_id' LIMIT 1");
		...
		<footer>
			...
			<div class="container">
				<div class="footer-logo">
					<a href="index.html"><span>Requi</span>site</a>
				</div>
				...
				<div class="copyrights">
					<p> © 2023 Requisite. All Rights Reserved | Designed by Rahul shukla</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
